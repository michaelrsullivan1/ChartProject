...
- `--delete-stale` cannot be used with `--view` or `--cohort`.
- to rebuild only mood outliers, run `python3 scripts/cache/rebuild_aggregate_snapshots.py --view aggregate-mood-outliers`.
